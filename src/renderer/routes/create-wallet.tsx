...
export default function CreateWallet() {
  ...
  return (
    ...
    >
      ...
      >
        {step <= 1 &&
         <Typography sx={{ fontSize: '1rem', mb: '1rem', height: "200px", textAlign: 'center' }}>
        ...
        {step === 2 &&
         <>
           <Typography sx={{ fontSize: '1rem', mb: '1rem', height: "auto", textAlign: 'center' }}>
             {"Please write down the following Chinese Characters which relate to private key..."}
           </Typography>
           <Typography sx={{ fontSize: '2rem', mb: '2rem', height: "auto", textAlign: 'center' }}>
             {"「申即静」"}<br/>
             {"竞味聚识咸，"}<br/>
             {"嚷气鞭兼即。"}<br/>
             {"匙稀遗翼饱，"}<br/>
